...
extern float h_ctl_rc_course_setpoint;
extern float h_ctl_rc_course_rate;
extern bool_t h_ctl_use_rc_course;
...
extern float h_ctl_attitude_hold_roll_gain;
extern float h_ctl_attitude_hold_rudder_gain;
